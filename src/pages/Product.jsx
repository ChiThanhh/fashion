...
import ProductItemSecond from "./ProductItemSecond";
...
const Product = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      brand: "Nike",
      price: 149.99,
      image: "https://via.placeholder.com/300x400?text=Giày+Air+Max",
      discount: true,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      brand: "H&M",
      price: 89.99,
      image: "https://via.placeholder.com/300x400?text=Váy+Lụa",
      discount: true,
    },
    {
      id: 5,
      ...
      brand: "Ray-Ban",
      price: 179.99,
      image: "https://via.placeholder.com/300x400?text=Kính+Mát",
      discount: false,
    },
    {
      id: 6,
      ...
      brand: "Levi's",
      price: 69.99,
      image: "https://via.placeholder.com/300x400?text=Quần+Jeans",
      discount: false,
    },
    {
      id: 7,
      ...
      brand: "Nike",
      price: 99.99,
      image: "https://via.placeholder.com/300x400?text=Đồng+Hồ",
      discount: true,
    },
    {
      id: 8,
      ...
      brand: "Adidas",
      price: 119.99,
      image: "https://via.placeholder.com/300x400?text=Giày+Chạy+Bộ",
      discount: false,
    },
    {
      id: 9,
    ...
    },
    {
      ...
      brand: "Samsonite",
      price: 89.99,
      image: "https://via.placeholder.com/300x400?text=Balo+Laptop",
      discount: true,
    },
    {
      id: 11,
      ...
      brand: "H&M",
      price: 19.99,
      image: "https://via.placeholder.com/300x400?text=Mũ+Bucket",
      discount: false,
    },
    {
      id: 12,
      ...
      brand: "Clarks",
      price: 159.99,
      image: "https://via.placeholder.com/300x400?text=Giày+Tây",
      discount: true,
    },
    {
      id: 13,
      ...
      brand: "Zara",
      price: 59.99,
      image: "https://via.placeholder.com/300x400?text=Áo+Hoodie",
      discount: false,
    },
    {
      id: 14,
      ...
      brand: "Gucci",
      price: 299.99,
      image: "https://via.placeholder.com/300x400?text=Thắt+Lưng",
      discount: false,
    },
    {
      id: 15,
      ...
      brand: "Puma",
      price: 109.99,
      image: "https://via.placeholder.com/300x400?text=Sneaker+Nữ",
      discount: true,
    },
    {
      id: 16,
      ...
      brand: "H&M",
      price: 39.99,
      image: "https://via.placeholder.com/300x400?text=Quần+Short",
      discount: false,
    },
    {
      id: 17,
      ...
      brand: "Nike",
      price: 49.99,
      image: "https://via.placeholder.com/300x400?text=Túi+Đeo+Chéo",
      discount: true,
    },
    {
      id: 18,
      ...
      brand: "Uniqlo",
      price: 39.99,
      image: "https://via.placeholder.com/300x400?text=Áo+Sơ+Mi",
      discount: false,
    },
    {
      id: 19,
      ...
      brand: "Zara",
      price: 129.99,
      image: "https://via.placeholder.com/300x400?text=Giày+Lười",
      discount: false,
    },
    {
      id: 20,
      ...
      brand: "Uniqlo",
      price: 14.99,
      image: "https://via.placeholder.com/300x400?text=Găng+Tay",
      discount: true,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200">
      ...
      <div className="relative bg-black text-white  mb-8">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <p data-aos="fade-down" data-aos-delay="500" className="text-sm mt-2">
            Khám phá phong cách dẫn đầu xu hướng
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-1/4 bg-white p-4 rounded-md shadow-sm">
            <h2
              data-aos="fade-right"
              data-aos-delay="100"
              className="text-lg font-medium text-black mb-3 flex items-center"
            >
              Bộ Lọc
            </h2>
